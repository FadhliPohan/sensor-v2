					...
					<table class="table table-bordered" style="width:300px">
						...
						<!-- <table>
							<tr> -->
								...
								if(!empty($vc)){
									echo '<span style="margin-left: 250px;">Very Cold</span>';
								}
								if(!empty($c)){
									echo '<span style="margin-left: 250px;">Cold</span>';						
								}
								if(!empty($n)){
									echo '<span style="margin-left: 250px;">Normal</span>';						
								}
								if(!empty($h)){
									echo '<span style="margin-left: 250px;">Hot</span>';
								}
								if(!empty($vh)){
...
<!-- PERHITUNGAN UNTUK DEFUZYFICATION -------------------------------------------------------------------------------------------->
				...
				//	echo"INSERT INTO tb_hasil_menit(tanggal,suhu,sm,humidity,li,defuz,nilai)VALUES('".$_POST['tanggal']."','".$_POST['suhu']."','".$_POST['sm']."','".$_POST['hm']."','".$_POST['li']."','$gol','".$hasil_meni."')";
