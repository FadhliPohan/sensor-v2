		...
		<div class="panel panel-default">
				...
				<div class="container">
				  ...
				  <ul class="nav nav-tabs">
					<li class="active"><a data-toggle="tab" href="#menu1">Temperatur</a></li>
					<li><a data-toggle="tab" href="#menu2">Soil Mesure</a></li>
					<li><a data-toggle="tab" href="#menu3">Humidity</a></li>
					<li><a data-toggle="tab" href="#menu4">Light Insensity</a></li>
					<li><a data-toggle="tab" href="#menu5">Hasil</a></li>
				  </ul>
				...
				<table class="table table-bordered" style="width:900px">
					...
					while($row=mysql_fetch_array($sql)){
						if($row['is_sub_golongan'] == 1){
												$nama_golongan="Trapesium";
												$nilai_b="D";
											}else{
												$nama_golongan="Segitiga";
												$nilai_b="B";
											}
						echo"
						<tr>
						...
						<tr>
							...
							<td>(RUMUS)=".nilai_parameter_a($row['is_sub_golongan'],$row['keterangan'],$_POST['suhu'],$row['keterangan_nilai'],0,"r")."</td>
							<td>(HASIL)=".nilai_parameter_a($row['is_sub_golongan'],$row['keterangan'],$_POST['suhu'],$row['keterangan_nilai'],0,"h")."</td>
...
<!-- PERHITUNGAN UNTUK SOIL MOISTURE -------------------------------------------------------------------------------------------->
			...
			<div id="chartContainer2" style="height: 370px;width:900px;"></div>
					 </div>
				<table class='table table-bordered'>
						<tr>
										<td>Fungsi Keanggotaan</td>
				...
				<table class="table table-bordered" style="width:900px">
					...
					while($row=mysql_fetch_array($sql)){
						...
						<tr>
							...
							<td>(RUMUS)=".nilai_parameter_a($row['is_sub_golongan'],$row['keterangan'],$_POST['sm'],$row['keterangan_nilai'],1,"r")."</td>
							<td>(HASIL)=".nilai_parameter_a($row['is_sub_golongan'],$row['keterangan'],$_POST['sm'],$row['keterangan_nilai'],1,"h")."</td>
				...
				<table class="table table-bordered" style="width:900px">
					...
					while($row=mysql_fetch_array($sql)){
						...
						<tr>
							...
							<td>(RUMUS)=".nilai_parameter_a($row['is_sub_golongan'],$row['keterangan'],$_POST['hm'],$row['keterangan_nilai'],2,"r")."</td>
							<td>(HASIL)=".nilai_parameter_a($row['is_sub_golongan'],$row['keterangan'],$_POST['hm'],$row['keterangan_nilai'],2,"h")."</td>
				...
				<table class="table table-bordered" style="width:900px">
					...
					while($row=mysql_fetch_array($sql)){
						...
						<tr>
							...
							<td>(RUMUS)=".nilai_parameter_a($row['is_sub_golongan'],$row['keterangan'],$_POST['li'],$row['keterangan_nilai'],3,"r")."</td>
							<td>(HASIL)=".nilai_parameter_a($row['is_sub_golongan'],$row['keterangan'],$_POST['li'],$row['keterangan_nilai'],3,"h")."</td>
...
<!-- PERHITUNGAN UNTUK FUZYFICATION -------------------------------------------------------------------------------------------->
					...
					<h4>DIFUZZYFICATION</h1>
					<table class='table table-bordered'>
					<?php
							$hasil_meni=$total / $total_bagi;
							echo"<tr><td>".round($hasil_meni)." Menit</td></tr>";
