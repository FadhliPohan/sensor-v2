...
<link href="css_bc/bootstrap.min.css" rel="stylesheet" type="text/css">
<link href="css_bc/brain-theme.css" rel="stylesheet" type="text/css">
<link href="css_bc/styles.css" rel="stylesheet" type="text/css">
<link href="css_bc/font-awesome.min.css" rel="stylesheet" type="text/css">
<link href='css_bc/font.css' rel='stylesheet' type='text/css'>
...
?>
                <form name="login" action="forgot_save.php" role="form" method="post">
                    <div class="panel panel-default">
                        <div class="panel-heading"><h6 class="panel-title"><i class="fa fa-user"></i> Change Password</h6></div>
                        <div class="panel-body">
                            ...
                            <div class="row form-actions">
                                ...
                                <div class="col-xs-6">
                                    <button type="submit" class="btn btn-warning pull-right"><i class="fa fa-bars"></i> Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
