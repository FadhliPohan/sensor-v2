...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	data: [{
		...
		while($row=mysql_fetch_array($sql)){
			$y=$row['temperature']-1;
		?>
			{ x: <?php echo $row['temperature']; ?> , y:  <?php echo $y; ?> },
		<?php
		}
		?>
		]
	},
	{
		...
		while($row=mysql_fetch_array($sql)){
		?>
			{ x: <?php echo $row['temperature']; ?> , y:  <?php echo $row['temperature']; ?> },
		<?php
		}
		?>
		]
...
var chart = new CanvasJS.Chart("chartContainer2", {
	...
	data: [{
		...
		?>
			{ x: <?php echo $row['soilmoisture']; ?> , y:  <?php echo $y; ?> },
		<?php
		}
		?>
		]
	},
	{
		...
		while($row=mysql_fetch_array($sql)){
		?>
			{ x: <?php echo $row['soilmoisture']; ?> , y:  <?php echo $row['soilmoisture']; ?> },
		<?php
		}
		?>
		]
...
var chart = new CanvasJS.Chart("chartContainer3", {
	...
	data: [{
		...
		while($row=mysql_fetch_array($sql)){
			$y=$row['humidity']-1;
		?>
			{ x: <?php echo $row['humidity']; ?> , y:  <?php echo $y; ?> },
		<?php
		}
		?>
		]
	},
	{
		...
		while($row=mysql_fetch_array($sql)){
		?>
			{ x: <?php echo $row['humidity']; ?> , y:  <?php echo $row['humidity']; ?> },
		<?php
		}
		?>
		]
...
var chart = new CanvasJS.Chart("chartContainer4", {
	...
	data: [{
		...
		while($row=mysql_fetch_array($sql)){
			$y=$row['intensity']-1;
		?>
			{ x: <?php echo $row['intensity']; ?> , y:  <?php echo $y; ?> },
		<?php
		}
		?>
		]
	},
	{
		...
		while($row=mysql_fetch_array($sql)){
		?>
			{ x: <?php echo $row['intensity']; ?> , y:  <?php echo $row['intensity']; ?> },
		<?php
		}
		?>
		]
